...
exports.getAlignmentColumn = exports.getIndentationEdit = void 0;
function findMatchingOpeningParen(document, lineIndex) {
    let bracketLevel = 0;
    ...
    while (currentScanLineIndex >= 0) {
        for (let c = currentScanText.length - 1; c >= 0; c--) {
            if (isInStringOrComment(currentScanText, c))
                continue;
...
function getIndentationEdit(document, position, tabSize = 2) {
...
exports.getIndentationEdit = getIndentationEdit;
function findExpressionStart(document, lineIndex) {
    let bracketLevel = 0;
    let currentScanLineIndex = lineIndex;
    let currentScanText = document.lineAt(currentScanLineIndex).text;
    while (currentScanLineIndex >= 0) {
...
function findPipeAnchor(document, lineIndex) {
